...
?>
<?= form_open_multipart('admin/insert_user');?>
<?php
if (@$_SESSION['user_login']!='')
{
    echo '
    ...
    <div class="contact-section">
        <div class="container">
            <form>
                    ...
                    <div class="form-group">
                        <h3 style="text-align: center"><span class="label label-warning">Family name</span></h3>
                ...
                <button type="submit" class="btn btn-default submit"><i class="fa fa-paper-plane" aria-hidden="true"></i>Save User</button>
            </form>
        </div>
</section>
</form>
<div class="container">
    ...
    <tr id="tr_'.$value['id'].'">
        ...
        <td><a href="'.base_url().'/admin/update_user/'.$value['id'].'" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></a></td>
